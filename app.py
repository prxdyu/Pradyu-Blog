...
gravatar = Gravatar(app,
                    ...
                    base_url=None)
##CONNECT TO DB
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv("DATABASE2_URL","sqlite:///blog.db")
...
def get_all_posts():
    ...
    return render_template("index.html", all_posts=posts,time_of_the_day=time_of_day)
